...
public class LoginActivity extends BaseActivity  {
    ...
    private CheckBox mSupervisorCheckBox ;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mSupervisorCheckBox = (CheckBox) findViewById(R.id.is_supervisor);
        mSupervisorCheckBox.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                if (isChecked) {
                    MyApplication.sCache.put(Constants.IS_SUPERVISOR, true);
                    mIsSuperVisor = true ;
                } else {
    ...
    public class UserLoginTask extends AsyncTask<Void, Void, Boolean> {
        ...
        private SaveListener mLoginListener = new SaveListener() {
            ...
            public void onSuccess() {
                if (mIsSuperVisor) {
                    gotoActivity(LoginActivity.this, MonitorActivity.class, null);
                } else {
        ...
        protected Boolean doInBackground(Void... params) {
            ...
            if (accountInfo == null) {
                ...
                accountInfo.setUsername(mEmail);
                accountInfo.setPassword(mPassword);
            }
            accountInfo.login(LoginActivity.this, mLoginListener);
